...
import SettingsSkeleton from "../skeleton/SettingSkeleton"
  ...
  return (
    <div className="flex max-w-[100vw]">
      ...
      <div className="w-full ml-0 flex flex-col md:ml-[230px] md:w-[calc(100%-230px)]">
        ...
        {/* ✅ Show skeleton while Firebase is confirming auth */}
        {loadingUser ? (
          <SettingsSkeleton />
        ) : isLoggedIn ? (
          <div className="flex flex-col pt-[40px] pb-[40px] items-start max-w-[1400px] w-full h-full justify-between py-0 px-[32px] my-0 mx-auto">
            ...
            <div className="flex flex-col items-start gap-[8px] pb-[24px]">
              ...
              <span>
                {plan === "premium" ? "Premium" : plan === "vip" ? "VIP" : "Basic"}
              </span>
              {!plan && (
                <Link
                  href="/plans"
                  className="text-white bg-[#320580] py-[12px] px-[16px] flex justify-center items-center gap-[6px] text-[14px] font-medium rounded-[8px]"
                >
                  {loading ? (
                    <>
                      <span>Upgrade</span>
